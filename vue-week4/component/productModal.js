      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content border-0">
            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="mb-3">
                  ...
                  <input v-model="tempProduct.imageUrl" type="text" class="form-control mb-2" placeholder="請輸入圖片連結" id="imageUrl">
                  ...
                  <div class="mb-1" v-for="(image, key) in tempProduct.imagesUrl" :key="key">
                    <div class="mb-3">
                      ...
                      <input v-model="tempProduct.imagesUrl[key]" type="text" class="form-control"
                        placeholder="請輸入圖片連結" id="moreImageUrl">
                    </div>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="$emit('update-product')">
              確認
            </button>
          </div>
        </div>
